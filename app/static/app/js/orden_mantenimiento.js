document.addEventListener('DOMContentLoaded', function() {
    ...
    // ... La sección 1 (popularDropdown) no cambia ...
    async function popularDropdown(urlApi, idDropdown, textoDefault) {
        ...
        try {
            ...
            selectElement.innerHTML = `<option value="" selected>${textoDefault}</option>`;
            data.forEach(item => {
            ...
            console.error(`Error al cargar datos para ${idDropdown}:`, error);
            selectElement.innerHTML = `<option selected>Error al cargar</option>`;
        }
    }
    popularDropdown('/api/tipos_om/', 'tipoOm', 'Selecciona un tipo');
    popularDropdown('/api/talleres/', 'taller', 'Selecciona un taller');


    // =======================================================
    // SECCIÓN 2: LÓGICA DEL MODAL (CON PAGINACIÓN MEJORADA)
    // =======================================================
    ...
    function renderEquiposList() {
        ...
        pageItems.forEach(equipo => {
            ...
            listItem.addEventListener('click', function() {
                mainEquipoInput.value = this.dataset.code;
                const modalInstance = bootstrap.Modal.getInstance(equipoModal);
                modalInstance.hide();
            });
